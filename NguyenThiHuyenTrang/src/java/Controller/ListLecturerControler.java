 ...
 * @author minhn
 */
public class ListLecturerControler extends HttpServlet {
   private UserContext user;
    ...
    throws ServletException, IOException {
        ...
        List<User> list = user.getUsersByRole("lecturer");
        request.setAttribute("lecturers", list);
        request.getRequestDispatcher("list_lecturer.jsp").forward(request, response);
    } 
