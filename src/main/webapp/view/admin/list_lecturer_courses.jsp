...
<table border="1">
    ...
    <tr>
        ...
        <td>
            <a href="<%= request.getContextPath() %>/admin/lecturer/lecturerCourses/<%= course.getId() %>?lecturerId=<%= request.getParameter("lecturerId") %>">
                View Students
            </a>
        </td>
    </tr>
...
<br>
<a href="<%= request.getContextPath() %>/admin/dashboard/lecturers">Back to List Lecturer</a>
</body>
</html>
